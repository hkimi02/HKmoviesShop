...
if (isset($_POST['update'])) {
    ...
    if($_SESSION['isAdmin']==1){
        header('location:../admin/index.php?msg=info updated succesfully&class=success');
    }else if($_SESSION['isEmploye']==1){
        header('location:../profile_employe/index.php?msg=info updated succesfully&class=success');
    }else{
        header('location:../profile_user/index.php?msg=info updated succesfully&class=success');
    }
}
}
include 'home.phtml';
